...
def test_import():
    ...
    This test checks if the package `hw1` is properly installed and if
    its submodules (p2, p3, p4) can be successfully imported.
    ...
    """
    try:
        from hw1 import p2, p3, p4  # import required submodules
